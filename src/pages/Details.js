...
const Details = () => {
  ...
  const genre = data.genre.map((genre, i) => {
    return (
      <span
        key={i}
        class="text-s inline-block py-1 px-2.5 leading-none text-center whitespace-nowrap align-baseline font-bold bg-gray-200 text-gray-700 rounded"
      >
        {genre}
      </span>
    );
            ...
            <div class="grow-0 shrink-0 basis-auto w-full lg:w-6/12 xl:w-8/12">
              <div class="px-6 py-12 md:px-12">
                ...
                <div class="flex justify-end py-6 ">
                  <h3 class="text-2xl font-bold mb-4 text-black-400 display-5">
                    {data.provider}
                  </h3>
                </div>
                <div class="grid lg:gap-x-12 xl:grid-cols-3 mb-12">
                  <div class="mb-12 md:mb-0 flex flex-col align-center justify-center">
                    <h5 class="text-lg font-medium text-gray-500 mb-0 text-center">
                      Total views
                    </h5>
                      ...
                      <table class="min-w-full text-center">
                        <tbody>
                          <tr class="bg-white border-b">
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 text-teal-800">
                              Peacock
                            </td>
                          ...
                          <tr class="bg-white border-b">
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 text-indigo-800">
                              Now Tv
                            </td>
                            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                          ...
                          <tr class="bg-white border-b">
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 text-pink-800">
                              Sky Go
                            </td>
                            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
